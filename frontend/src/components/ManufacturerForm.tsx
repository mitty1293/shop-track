...
import { Manufacturer, PatchedManufacturerInput } from '../api/client';
...
interface ManufacturerFormProps {
    ...
    onSubmit: (data: PatchedManufacturerInput) => void;
        ...
        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
            <Stack spacing={2}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 1, mt: 2 }}>
                    ...
                    >
                        {isSubmitting ? 'Saving...' : (initialData ? 'Save Changes' : 'Save Manufacturer')}
                        {isSubmitting && (
                            <CircularProgress
                                size={24}
                                sx={{
